...
## How a SIP actually works <!-- chunk_id: sip-mechanics -->
...
## How equity/debt allocation should shift with age <!-- chunk_id: asset-allocation-by-age -->
...
## What return to expect from equity <!-- chunk_id: equity-expected-returns -->
